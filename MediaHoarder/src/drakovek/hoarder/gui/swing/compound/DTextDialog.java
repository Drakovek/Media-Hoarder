...
public class DTextDialog extends BaseGUI
{
	...
	public String openTextDialog(DFrame owner, final String titleID, final String[] messageIDs, final String fieldText)
	{
		...
		returnString = null;
		dialog = new DDialog(owner, getDialogPanel(messageIDs, fieldText), getSettings().getLanguageText(titleID), true, getSettings().getFontSize() * getSettings().getFrameWidth(), 0);
